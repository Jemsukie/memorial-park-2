const HighChartsMap = () => {
  ;(async () => {
    ...
    const chart = Highcharts.mapChart('container', {
      title: {
        text: 'MEMORIAL LOT MAPPING AND INFORMATION SYSTEM FOR KATONINONGAN MEMORIAL GARDEN',
      },
          ...
          accessibility: {
            point: {
              valueDescriptionFormat:
                '{point.capital}, {point.parentState}. Population {point.population}. Latitude {point.lat:.2f}, longitude {point.lon:.2f}.',
            },
          },
